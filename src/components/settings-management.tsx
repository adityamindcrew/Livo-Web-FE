...
import { Settings, Save, RotateCcw, Bell, Shield, Palette, Database, Mail, Eye, EyeOff } from "lucide-react"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => handleInputChange("loginAttempts", Number.parseInt(e.target.value))}
          />
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => handleInputChange("passwordPolicy.minLength", Number.parseInt(e.target.value))}
            />
          </div>
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleInputChange("passwordPolicy.requireUppercase", checked)}
              />
            </div>
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleInputChange("passwordPolicy.requireNumbers", checked)}
              />
            </div>
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleInputChange("passwordPolicy.requireSpecialChars", checked)}
              />
            </div>
          </div>
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">Notifications when new users register</p>
          </div>
          <Switch
            id="userRegistration"
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">Notifications when new tenants are created</p>
          </div>
          <Switch
            id="tenantCreation"
            checked={settings.tenantCreation}
            onCheckedChange={(checked) => handleInputChange("tenantCreation", checked)}
          />
        </div>
    ...
    <div className="space-y-6">
      ...
      <Card className="p-4 bg-blue-50 border-blue-200">
        <div className="flex gap-3">
          ...
          <div>
            <h4 className="text-sm font-medium text-blue-900 mb-2">Database Backup Information</h4>
            <p className="text-sm text-blue-800">
              Regular backups ensure your data is safe. Configure the frequency and retention period based on your
              needs. Automatic backups will run in the background without interrupting system operations.
            </p>
          </div>
        </div>
      </Card>
      ...
      <div className="bg-white border-b px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 leading-tight">System Settings</h1>
    ...
    {renderTabContent()}
          ...
          {hasChanges && (
            <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-end">
              ...
              <Button onClick={handleSave} className="bg-blue-600 hover:bg-blue-700 sm:w-auto">
